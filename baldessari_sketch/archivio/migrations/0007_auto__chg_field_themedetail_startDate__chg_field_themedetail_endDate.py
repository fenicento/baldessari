...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ThemeDetail.startDate'
        db.alter_column('archivio_themedetail', 'startDate', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ThemeDetail.endDate'
        db.alter_column('archivio_themedetail', 'endDate', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ThemeDetail.startDate'
        db.alter_column('archivio_themedetail', 'startDate', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'ThemeDetail.endDate'
        db.alter_column('archivio_themedetail', 'endDate', self.gf('django.db.models.fields.DateField')(null=True))
