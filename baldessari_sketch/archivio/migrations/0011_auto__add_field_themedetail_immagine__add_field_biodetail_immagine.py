...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ThemeDetail.immagine'
        db.add_column('archivio_themedetail', 'immagine',
                      self.gf('django.db.models.fields.files.ImageField')(default='img_documents/noimage.jpg', max_length=100),
                      keep_default=False)

        # Adding field 'BioDetail.immagine'
        db.add_column('archivio_biodetail', 'immagine',
                      self.gf('django.db.models.fields.files.ImageField')(default='img_documents/noimage.jpg', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ThemeDetail.immagine'
        db.delete_column('archivio_themedetail', 'immagine')

        # Deleting field 'BioDetail.immagine'
        db.delete_column('archivio_biodetail', 'immagine')
    ...
    models = {
        ...
        'archivio.biodetail': {
            ...
            'immagine': ('django.db.models.fields.files.ImageField', [], {'default': "'img_documents/noimage.jpg'", 'max_length': '100'}),
