...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ThemeDetail.testo'
        db.alter_column('archivio_themedetail', 'testo', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
        # Deleting field 'Letter.note'
        db.delete_column('archivio_letter', 'note')

        # Deleting field 'Drawing.note'
        db.delete_column('archivio_drawing', 'note')


    def backwards(self, orm):

        # Changing field 'ThemeDetail.testo'
        db.alter_column('archivio_themedetail', 'testo', self.gf('django.db.models.fields.TextField')(null=True))
        # Adding field 'Letter.note'
        db.add_column('archivio_letter', 'note',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Drawing.note'
        db.add_column('archivio_drawing', 'note',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
