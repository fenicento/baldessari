...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Letter.attivita'
        db.add_column('archivio_letter', 'attivita',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Drawing.attivita'
        db.add_column('archivio_drawing', 'attivita',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Letter.attivita'
        db.delete_column('archivio_letter', 'attivita')

        # Deleting field 'Drawing.attivita'
        db.delete_column('archivio_drawing', 'attivita')
